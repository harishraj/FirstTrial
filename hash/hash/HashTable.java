...
public class HashTable<K, V> {
	...
	public V insert(K key, V data) {
		...
		// Lets add the new hash node created below to the start of linked list
		// at nodes[hash] position
	...
	/**
	 * It Removes the given key from hash table. 1. Gets the hash using built in
